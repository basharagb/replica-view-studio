...
const MaintenanceSystem: React.FC<MaintenanceSystemProps> = ({ className }) => {
  const [selectedSilos, setSelectedSilos] = useState<number[]>([]);
  const [startDate, setStartDate] = useState<string>('');
  const [endDate, setEndDate] = useState<string>('');
  const [analyticsData, setAnalyticsData] = useState<MaintenanceData[]>([]);
  ...
  const generateAnalyticsData = useCallback(async (silos: number[], start: Date, end: Date) => {
    try {
      const dataPoints: MaintenanceData[] = [];
    ...
    <div className={`space-y-6 ${className}`}>
      ...
      >
        <div>
          ...
          <p className="text-gray-600">Correlate maintenance tasks with historical patterns</p>
      ...
      >
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">Maintenance Controls</CardTitle>
          </CardHeader>
        ...
        >
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="grid w-full grid-cols-3">
              <TabsTrigger value="correlation">Temperature-Maintenance Correlation</TabsTrigger>
              <TabsTrigger value="frequency">Maintenance Frequency</TabsTrigger>
            ...
            <TabsContent value="correlation" className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Temperature vs Maintenance Correlation</CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="frequency" className="space-y-4">
              <Card>
                <CardHeader>
                  <CardTitle>Maintenance Frequency Analysis</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-96 w-full">
                    <ResponsiveContainer width="100%" height="100%">
