...
const Dashboard = () => {
  ...
  const navigation = [
    ...
    { name: 'Maintenance', href: '/reports', icon: FileText, description: 'Readings history and analytics' },
    { name: 'Maintenance', href: '/maintenance', icon: Wrench, description: 'Industrial maintenance and system diagnostics' },
